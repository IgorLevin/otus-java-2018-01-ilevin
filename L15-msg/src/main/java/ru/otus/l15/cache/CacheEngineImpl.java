...
public class CacheEngineImpl<K, V> implements CacheEngine<K, V> {
    ...
    public CacheEngineImpl(int maxElements, long lifeTimeMs, long idleTimeMs, boolean isEternal, Address address, MessageSystemContext context) {
    ...
    public void init() {
        ...
        context.setCacheAddress(address);
    ...
    public synchronized void put(CacheElement<K, V> element) {
        ...
        if (elements.size() >= maxElements) {
            ...
            log.info("Cache size exceeded. Remove element: {}", firstKey);
        }
    ...
    public CacheInfo getInfo() {
        return new CacheInfoImpl(capacity(), size(), getHitCount(), getMissCount());
    }
